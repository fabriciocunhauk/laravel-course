<x-layout>
    ...
    <form method="POST" action="/jobs/{{ $job->id }}">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="title" id="title" value="{{ $job->title }}"
                                    ...
                                    placeholder="Shift Reader" required>
                            </div>
                        </div>
                        @error('title')
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6 gap-10">
            <div>
                <button form="delete-form" class="font-bold text-red-500">Delete</button>
            </div>
            <div class="space-x-5">
